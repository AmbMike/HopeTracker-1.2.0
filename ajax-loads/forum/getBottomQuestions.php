...
<div data-questions="container">
    ...
    <?php foreach ($ForumQuestions->mostAnswered($_GET['subcategory'], true) as $forum_question) : ?>
            ...
            <div class="row no-margins">
                ...
                <div class="cell img-cell">
                    <div class="author-box">
                        <span itemprop="author" itemscope itemtype="http://schema.org/Person" class="hidden"> <span  itemprop="name"  <?php echo $UserProfile->profile($forum_question['created_user_id']); ?> role="button"><?php echo User::Username($forum_question['created_user_id']); ?></span> </span>
                        <img <?php echo $UserProfile->profile($forum_question['created_user_id']); ?> role="button" src="/<?php echo RELATIVE_PATH . (User::user_info('profile_img',$forum_question['created_user_id'])) ? : DEFAULT_PROFILE_IMG; ?>" alt="<?php echo User::Username($forum_question['created_user_id']); ?>"  class="img-circle profile-img">
                    </div>
                </div>
            </div>
                ...
                <div data-answer="tables">
                    <?php foreach ( $forum_answers as $forum_answer) :  ?>
                        <div class="table">
                            ...
                            <div class="cell">
                                <div class="user-info">
                                    <span itemprop="author" itemscope itemtype="http://schema.org/Person" class="username"><span itemprop="name"  <?php echo $UserProfile->profile($forum_answer['user_id']); ?> role="button"><?php echo User::Username($forum_answer['user_id']); ?></span></span>
