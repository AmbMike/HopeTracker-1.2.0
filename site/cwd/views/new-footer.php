            ...
            <div class="con">
                <div class="row">
                    ...
                    <div class="col-sm-5 text-right">
                        <button  <?php echo $SignUpBtn->btnActionHTML; ?>  class="btn btn-default green">
				            <?php  echo $SignUpBtn->optionBtnText('Get Hope'); ?>
                        </button>
                    </div>
                    <div class="col-xs-12">
                        <div class="legal-box">
...
<?php if(ENV == 'dev'): ?>
    ...
    function script_dev_version($directory){
        ...
        $path = $_SERVER["DOCUMENT_ROOT"].'/site/cwd/js/'.$directory;
        ...
        foreach ($files as $index => $file) {
            if ($file != ".") {
                if(is_file($path.'/'.$file)) {
                    echo '<script type="text/javascript" src="/site/cwd/js/'.$directory.'/' . $file . '"></script>' . PHP_EOL;
                }
            }
        }
    }
    /* Main Jquery Lib */
    echo '<script type="text/javascript" src="/site/cwd/js/jquery-3-1-1.js"></script>' . PHP_EOL;
    echo '<script type="text/javascript" src="/site/cwd/js/bootstrap/bootstrap.min.js"></script>' . PHP_EOL;

    ?>
    <script src="<?php echo TINYMCE; ?>" type="text/javascript"></script>
    <script src="/mod/croppic/croppic.js" type="text/javascript"></script>
    <script src="/site/cwd/js/concats/a.validation.js" type="text/javascript"></script>
    <?php
    ...
    ?>
    <script src="/site/cwd/js/shared.js" type="text/javascript"></script>
<?php else: ?>
    <script src="<?php echo TINYMCE; ?>" type="text/javascript"></script>
