        ...
        <div class="col-md-8">
            <main>
                <section class="box-one main-box">
                    <div class="table">
                        <div class="cell forum-count">
                            <h1 class="green-heading-lg">Community Forum</h1>
                        </div>
                        <div id="total-forums" class="cell forum-count text-right">
                                                                                    ...
                                                                                    <div class="table">
                                                                                        ...
                                                                                        <div class="cell">
                                                                                            <div class="links inline-block">
                                                                                                <a onclick="location.href='/forum/<?php echo $General->url_safe_string( $subcategory['sub_category']); ?>-<?php echo $latest_sub_cat_post['id']; ?>/<?php echo $General->url_safe_string($latest_sub_cat_post['title']); ?>'" class="title tooltip-mg" data-pt-title="<?php echo $latest_sub_cat_post['title']; ?>" data-pt-gravity="top" data-pt-animate="jello" data-pt-scheme="black" data-pt-size="small"><span class="title-label">Latest:</span> <?php echo $latest_sub_cat_post['title']; ?> </a>
                                                                                                <a onclick="location.href='/forum/<?php echo $General->url_safe_string( $subcategory['sub_category']); ?>-<?php echo $latest_sub_cat_post['id']; ?>/<?php echo $General->url_safe_string($latest_sub_cat_post['title']); ?>'" class="username tooltip-mg" data-pt-title="<?php echo date('F d, Y',$latest_sub_cat_post['create_date']); ?>" data-pt-gravity="top" data-pt-animate="jello" data-pt-scheme="black" data-pt-size="small"><?php echo ucfirst(User::user_info('fname',$latest_sub_cat_post['created_user_id']).' '.User::user_info('lname',$latest_sub_cat_post['created_user_id'])); ?>  | <span class="date"><?php echo date('F d, Y',$latest_sub_cat_post['create_date']); ?></span> </a>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="cell">
                                                                        ...
                                                                        <td width="56%" class="responsive-td">
                                                                            <div class="row">
                                                                                <div class="col-xs-12 like">
                                                                                    ...
                                                                                    <a class="link-title" href="/forum/<?php echo $General->url_safe_string( $subcategory['sub_category']); ?>-<?php echo $form_post['id']; ?>/<?php echo $forum_title_url; ?>"><?php echo $form_post['title']; ?></a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
