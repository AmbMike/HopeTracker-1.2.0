...
//Debug::data( $totalCompleteActivities );
        ...
        <div class="col-md-8">
            <main>
                ...
                <section class="box-one main-title-box session-container">
	                <?php include_once(ABSOLUTE_PATH_NO_END_SLASH. '/site/cwd/views/includes/course/index.php'); ?>
                </section>
                    ...
                    <div class="inside-box no-top no-bottom-p">
                        ...
                        <div id="progress-details">
                            ...
                            <div class="status">
                                ...
                                <p>(<span data-skipped-course><?php echo ($ActivitySessionSkipped->getAllSkippedSessions() > 0) ? count($ActivitySessionSkipped->getAllSkippedSessions()) : 0; ?></span>  skipped)</p>
                            </div>
                            <div class="content">
                                <?php
