<p data-session-item="2" onclick="location.href= RELATIVE_PATH + '<?php echo "/families-of-drug-addicts/user-". User::user_info("id")."/course/stop_enabling"; ?>'" class="heading <?php echo ($Courses->session_status(3,2) == true) ? 'pre-complete' : '' ; ?> ">
