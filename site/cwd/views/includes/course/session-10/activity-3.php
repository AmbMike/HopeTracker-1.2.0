<p data-session-item="3" onclick="location.href= RELATIVE_PATH + '<?php echo "/families-of-drug-addicts/user-". User::user_info("id")."/course/my_progress"; ?>'" class="heading <?php echo ($Courses->session_status(10,3) == true) ? 'pre-complete' : '' ; ?>  ">
