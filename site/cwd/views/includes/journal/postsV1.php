        ...
        <section <?php echo (isset($_GET['journal_id'])) ? 'data-no-lazy-load-posts ' : ''; ?>  data-post-parent="post" class="box-one no-p">
            <ul class="post">
                ...
                <?php if($LikePosts->checkLikedQuestion() == true): ?>
                    <li>
                        <span class="like-box"><i class="fa fa-thumbs-up" aria-hidden="true"></i> <span role="button" data-bound-post-like="btn" data-post-user-id="<?php echo $latest_post['user_id'];  ?>" data-post-id="<?php echo $latest_post['id'];  ?>" data-post-type="2">Liked </span></span>
                    </li>
                <?php else: ?>
                    <li>
                        <span class="like-box"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <span role="button" data-bound-post-like="btn" data-post-user-id="<?php echo $latest_post['user_id'];  ?>" data-post-id="<?php echo $latest_post['id'];  ?>" data-post-type="2">Like </span></span>
                    </li>
                <?php endif; ?>
