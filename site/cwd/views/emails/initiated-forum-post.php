 ...
 * Created On: 7/23/2018, 4:08 PM
 */;
?>
<?php
$base_url = 'https://ambrosiatc.com/hopetracker'
?>
                    ...
                    <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"><!--<![endif]-->
                        <div style="background-color: transparent; display: inline-block!important; width: 100% !important;">
                            <div style="Margin-top:20px; Margin-bottom:5px;">
                                ...
                                <span class="pre-email">There has been a new question recently added to HopeTracker.</span>
                        ...
                        <div style="background-color: transparent; display: inline-block!important; width: 100% !important;">
                            <div style="Margin-top:0px; Margin-bottom:0px;">
                                ...
                                <!--[if !mso]><!--><div style="Margin-right: 0px; Margin-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div style="font-size:12px;line-height:14px;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><strong><span style="font-size: 28px; line-height: 33px;">New Forum Question Posted </span></strong></p></div>
