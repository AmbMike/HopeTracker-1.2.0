    ...
    <div class="row">
        <div class="col-md-8" id="forum-single">
            <main>
                ...
                <section class="box-one no-p" itemscope itemtype="https://schema.org/QAPage">
                    <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question" id="post-single" class="table question-container" style="display: block">
                        <div class="row author-post-container" <?php echo ($ForumAnswers->userAnswered($user_id, $questionId) == true) ? 'data-user-answered="true"' : ''; ?>  data-question-body="true" data-question-id="<?php echo $Question->postId; ?>" data-question-user-id="<?php echo $Question->questionUsersId; ?>" data-post-type-id="<?php echo $Question->postType; ?>">
                            ...
                            <div class="post-text-box cell">
                                <h1 class="quote-box" data-question="question" itemprop="name" data-question="text">
                                ...
                                <div class="tracker-box">
                                    ...
                                    <div class="forum-details">
                                        ...
                                        <span class="liked-by-box" itemprop="author" itemscope itemtype="https://schema.org/Person">
                                           <span class="liked-by"  <?php echo PageLinks::userProfile($Question->questionUsersId); ?> itemprop="name" ><?php echo User::Username($Question->questionUsersId); ?></span>
                                        </span>
                                ...
                                <div class="author-text-box" data-question="description">
                                    <div itemprop="text"><?php echo  $Question->description; ?></div>
                        ...
                        <div class="visitor-response">
                            ...
                            <div class="textarea-box">
                                ...
                                <form class="pre-form-content" id="forum-answer-question-form-1" date-question-id="<?php echo $Question->postId; ?>">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading more-answers-box">
                                    <h4 class="panel-title">
                                        <div data-toggle="collapse"  <?php /** href="#collapse1" */?> href="#">
                                            <h3>
                                                <span class="more-answers"><i class="fa fa-caret-down" aria-hidden="true"></i>Answers(<span itemprop="answerCount"><?php echo $ForumAnswers->totalAnswersByQuestionId($Question->postId); ?></span>) Votes(<span itemprop="upvoteCount"><?php echo $ForumAnswers->totalVotesPerQuestionID($Question->postId); ?></span>)</span>
                                            </h3>
                                        </div>
                                    </h4>
                                </div>
                                <div id="collapse1" class="panel-collapse collapse in">
									...
									<?php $forum_answers = $ForumAnswers->getAnswersByMostLiked($Question->postId); ?>
                                    <div class="panel-body" data-question-answer-box="true" data-answers="container">
                                            ...
                                            <div id="answerOuter" data-questions="container" data-answer="output boxes">
                                                <div id="answerInner">
                                                    <div data-answer="tables">
                                                        <?php $topLikedAnswerID = $ForumAnswers->totalLikesForAnswer($Question->postId); ?>
                                                                ...
                                                                <div class="answer-data-container">
                                                                    ...
                                                                    <div class="post-text-box cell">
                                                                        ...
                                                                        <div class="user-count-container">
                                                                            ...
                                                                            <?php $answer_user_answer_count = $ForumAnswers->countAnswers(true, false,  $Question->postId) ?>
                   ...
                   ?>
                        <div id="related-questions" class="panel-group sub-posts">
                            <div class="panel panel-default">
                                <div class="panel-heading more-answers-box">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" <?php /** href="#collapse-related" */?>>
                                            <h3>
                                                        ...
                                                        <div class="related-question-item">
                                                            <div class="table">
                                                                ...
                                                                <div class="cell">
                                                                    ...
                                                                    <a href="/<?php echo RELATIVE_PATH; ?>forum/<?php echo $General->url_safe_string( $relatedQuestion['pageIdentifier']); ?>/"><?php echo $relatedQuestion['question']; ?></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php endforeach; ?>
